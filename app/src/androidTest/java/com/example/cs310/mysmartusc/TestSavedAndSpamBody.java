...
public class TestSavedAndSpamBody {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void testSavedAndSpamBody() {
        ...
        mActivityTestRule.getActivity().sendEmail("empty", "saveBody spamBody");
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.savedKeywords),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        editText.perform(replaceText("saveBody"), closeSoftKeyboard());
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.spamKeywords),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        editText2.perform(replaceText("spamBody"), closeSoftKeyboard());
...
//        pressBack();
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.emailBody), withText("saveBody spamBody"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        textView2.check(matches(withText("saveBody spamBody")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.emailBody), withText("saveBody spamBody"),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        textView4.check(matches(withText("saveBody spamBody")));
