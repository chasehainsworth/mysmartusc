...
public class TestUrgentSender {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void testSpamSender() {
        ...
        mActivityTestRule.getActivity().sendEmail("empty", "empty");
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.urgentKeywords),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        editText.perform(replaceText("@gmail.com"), closeSoftKeyboard());
