...
public class TestUrgentAndSavedInBody {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void testUrgentAndSavedInBody() {
        ...
        mActivityTestRule.getActivity().sendEmail("keyword", "urgent saved");
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.savedKeywords),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        editText2.perform(replaceText("saved"), closeSoftKeyboard());
