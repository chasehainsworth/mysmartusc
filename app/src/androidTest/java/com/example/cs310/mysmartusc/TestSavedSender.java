...
public class TestSavedSender {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void savedSenderTest() {
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.savedKeywords),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        editText2.perform(replaceText("@usc.edu"), closeSoftKeyboard());
        ...
        pressBack();
        mActivityTestRule.getActivity().sendEmail("SavedSenderTest", "flagged");
        try {
            Thread.sleep(40000);
        } catch (InterruptedException e) {
        ...
        DataInteraction textView = onData(anything())
                .inAdapterView(allOf(withId(R.id.listView),
                        childAtPosition(
                                ...
                                0)))
                .atPosition(0);
        textView.check(matches(withText("SavedSenderTest")));

       /* ViewInteraction textView2 = onView(
                allOf(withId(R.id.emailSubjectLabel), withText("BLANK"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("BLANK")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.emailBody), withText("BLANK\r\n"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class),
                                        0),
                                3),
                        isDisplayed()));
        textView3.check(matches(withText("BLANK\r "))); */
