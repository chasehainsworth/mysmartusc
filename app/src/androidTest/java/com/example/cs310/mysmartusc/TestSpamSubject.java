...
public class TestSpamSubject {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void testSpamSubject() {
        ...
        mActivityTestRule.getActivity().sendEmail("spamSubject", "empty");
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.spamKeywords),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        editText.perform(replaceText("spamSubject"), closeSoftKeyboard());
...
//        pressBack();
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.emailSubjectLabel), withText("spamSubject"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("spamSubject")));
